...
public class UsuarioServiceIntegrationTest {
    ...
    public void cadastrarUsuario_sucess() throws EmailEmUsoException {
        SuccessMessageRepresentation result = usuarioService.
                cadastrarUsuario(criarCadastrarUsuarioRequestRepresentation());

        Assertions.assertNotNull(result);
        Assertions.assertEquals("O usuário Usuário Teste foi cadastrado com sucesso!"
                , result.getMessage());
    }
